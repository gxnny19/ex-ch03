...
//	    http://localhost:8080/article-post
	    ...
	    public String articlePost(@ModelAttribute dto.ArticleRequest request) {
...
//	    http://localhost:8080/article-postman
	    ...
	    public String articlePostman(@RequestBody dto.ArticleRequest request) {
	    	String result = "제목: " + request.title() + "\n내용: " + request.content();
	    	return result;
	    }
	    
	    @PostMapping("/article-auto")
	    public String articleAuto(dto.ArticleRequest request) {
	    	String result = "제목: " + request.title() + "\n내용: " + request.content();
	    	return result;
	    }
	}
